          ...
          child: dataList.isNotEmpty
            ...
            itemBuilder: (context, index) {
              ...
              for (String photo in photoList) {
                updatedPhotoList.add('${URL.photoURL}others/$photo');
              }
...
class MultiLineChipOther extends StatelessWidget {
  final String label;
  final String price;
